...
* *M* = mean temperature
* *R* = the maximum deviation of temperatures from *M* (e.g., if the range of temperatures is 14‒25 and *M* = 20, then *R* = 6)
...
This returns the CTE for each nest for each date. You can then average this value over the days of your study, as well as looking at the variation and range of CTE values.
