...
#' @param R (integer) Maximum deviation of temperatures from M for a given day in degrees centigrade (e.g., if the range of temperatures is 14‒25 and M = 20, then R = 6)
